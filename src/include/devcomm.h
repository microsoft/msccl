...
#define MSCCL_MAX_NUM_THREAD_BLOCKS 108 // set this to 108 which is the number of SMs on A100

static_assert(MAXCHANNELS*MSCCL_MAX_NUM_THREAD_BLOCKS_PER_CHANNEL >= MSCCL_MAX_NUM_THREAD_BLOCKS, "MAXCHANNELS*MSCCL_MAX_NUM_THREAD_BLOCKS_PER_CHANNEL should bigger than MSCCL_MAX_NUM_THREAD_BLOCKS");
